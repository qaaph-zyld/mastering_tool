...
#
# v2: STEREO PHASE CORRELATION block aggregates per-frame
# lavfi.aphasemeter.phase metadata into mean / min / max — the
# correlation decision input for whether stereo widening is safe.
# (v1 grep approach silently produced empty output.)
# ============================================================
set -e
